...
func TestFqSetString(t *testing.T) {
	tests := map[string]struct {
		...
		"last > mont(last)": {input: "52435875175126190479447740508185965837690552500527637822603658699938581184512", want: fq{0x71d10733e538dac3, 0x0a958b901809ec37, 0xa03db1c7c4895ee7, 0xf108e16b841685d4, 0xb38e41548b0775f2, 0x0623deb3b8141c9a}, err: nil},
		"out of bounds":     {input: "52435875175126190479447740508185965837690552500527637822603658699938581184513", err: errOutOfBounds},
	}
	for name, tc := range tests {
		t.Run(name, func(t *testing.T) {
