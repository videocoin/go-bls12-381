...
var (
	...
	g1X, _ = fqMontgomeryFromBig(bigFromBase10("3685416753713387016781088315183077757961620795782546409894578378688607592378376318836054947676345821548104185464507"))

	// g1Y is the y-coordinate of G1's generator in the Montgomery form
	g1Y, _ = fqMontgomeryFromBig(bigFromBase10("1339506544944476473020471379941921221584933875938349620426543736416511423956333506472724655353366534992391756441569"))

	// g2X0 is the c0 x-coordinate of G2's generator in the Montgomery form
	g2X0, _ = fqMontgomeryFromBig(bigFromBase10("352701069587466618187139116011060144890029952792775240219908644239793785735715026873347600343865175952761926303160"))

	// g2X1 is the c1 x-coordinate of G2's generator in the Montgomery form
	g2X1, _ = fqMontgomeryFromBig(bigFromBase10("3059144344244213709971259814753781636986470325476647558659373206291635324768958432433509563104347017837885763365758"))

	// g2Y0 is the c0 y-coordinate of G2's generator in the Montgomery form
	g2Y0, _ = fqMontgomeryFromBig(bigFromBase10("1985150602287291935568054521177171638300868978215655730859378665066344726373823718423869104263333984641494340347905"))
